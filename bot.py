...
flirt_phrases = [
    ...
    "@luzha_ki как бы я хотел, чтобы наш нерушимый брак был настоящим😌... это ведь так рамонтично🤭~ ты, я..)) и не смотря на будущие невзгоды~ мы все равно будем считаться парой~ пока смерть не разлучит нас)))))😝",
